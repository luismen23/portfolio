...
const socialLinks = [
  {
    ...
    img: <SiGmail className='w-[20px] h-[20px] sm:w-[25px] sm:h-[25px]' />,
    id: 1,
    name: 'Send me a Mail',
  },
  {
    href: 'https://www.linkedin.com/in/luismendoza23/',
    img: <FaLinkedin className='w-[20px] h-[20px] sm:w-[25px] sm:h-[25px]' />,
    id: 2,
    name: 'Linkedin',
  },
  {
    href: 'https://github.com/luismen23?tab=repositories',
    img: <FaGithub className='w-[20px] h-[20px] sm:w-[25px] sm:h-[25px]' />,
    id: 3,
    name: 'GitHub',
  },
  {
    href: 'https://twitter.com/luismendoza23',
    img: <FaXTwitter className='w-[20px] h-[20px] sm:w-[25px] sm:h-[25px]' />,
    id: 4,
    name: 'X',
  },
  {
  ...
  return (
    <div className='flex justify-center items-center pt-10 w-full relative h-[8rem]'>
      <div className='flex flex-col md:flex-row md:justify-between md:w-[700px] xl:w-[900px] w-[400px] justify-center items-center m-auto z-10 gap-3'>
        <motion.h1
          className='md:text-5xl sm:text-4xl text-3xl'
